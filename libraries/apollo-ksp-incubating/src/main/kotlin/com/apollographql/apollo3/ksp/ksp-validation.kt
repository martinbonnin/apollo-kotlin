...
//) {
//  private val possibleTypes = mutableMapOf<SirClassName, MutableSet<String>>()
//
//  init {
...
//    val className = ksType.declaration.asClassName()
//
...
//}
//
//private fun ResolverClassName.toIrClassName(): SirClassName {
//  return SirClassName(packageName, simpleNames)
//}
//
//
...
//  val className = type.declaration.asClassName()
