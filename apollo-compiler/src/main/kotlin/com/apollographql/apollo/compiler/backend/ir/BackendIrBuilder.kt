...
//            frontendIr.operations.map { operation ->
//          operation.buildBackendIrOperation()
//        },
        fragments = emptyList()
//            frontendIr.fragmentDefinitions.map { fragment ->
...
//    )
//
//    val dataField = FrontendIr.Field(
//        name = "data",
//        alias = null,
//        arguments = emptyList(),
...
//  }
//
//  private fun FrontendIr.Field.buildBackendIrField(selectionKey: SelectionKey): BackendIr.Field {
